  ...
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">
        <h1>Juegos</h1>
        <?php?>
          <a href="?c=juegos&a=Ingresar_Juego" class="btn btn-success">Crear</a>
        <?php?>
      </header>
              ...
              <tr>
                ...
                <td>
                  <?php?>
                    ...
                    <a class="fa fa-trash btn btn-danger btn-sm" href="?c=juegos&a=Borrar_Juego&id=<?=$juego->get_Id()?>"></a>
                  <?php?>
